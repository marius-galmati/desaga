...
export const adminContract = c.router({
  ...
  listDishEvaluations: {
    method: "GET",
    path: "/admin/dishes/:id/evaluations",
    summary: "Individual evaluations of a dish (dashboard drill-down), newest first",
    pathParams: idParams,
    responses: { 200: dishEvaluationListSchema, 401: apiErrorSchema, 404: apiErrorSchema },
  },
  getEvaluationDetail: {
    method: "GET",
    path: "/admin/evaluations/:id",
    summary: "Full 6-criteria report for one evaluation, as scored, with photos",
    pathParams: idParams,
    responses: { 200: evaluationDetailSchema, 401: apiErrorSchema, 404: apiErrorSchema },
  },
  deleteEvaluation: {
    method: "DELETE",
    path: "/admin/evaluations/:id",
    pathParams: idParams,
    body: z.object({}),
    summary: "Soft-delete an evaluation (kept for retention, dropped from reports)",
    responses: { 200: okResponseSchema, 401: apiErrorSchema, 404: apiErrorSchema },
  },
